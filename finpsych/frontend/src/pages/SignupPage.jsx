    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              ...
              <input
                ...
                placeholder="Alex Kumar" className="fin-input"
              />
            </div>
            <div className="col-span-2">
              ...
              <input
                ...
                placeholder="you@example.com" className="fin-input"
              />
            </div>
            <div className="col-span-2">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Min 6 characters" className="fin-input pr-11"
                  minLength={6}
                />
            ...
            <div>
              ...
              <input
                ...
                placeholder="₹50,000" className="fin-input" min="0"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-400 mb-1.5">
              ...
              <input
                ...
                placeholder="1" className="fin-input" min="1" max="31"
              />
            </div>
          </div>
          ...
          >
            {loading ? (
              <><div className="w-4 h-4 border-2 border-surface-900/30 border-t-surface-900 rounded-full animate-spin" />Creating account...</>
            ) : 'Create Account →'}
          </motion.button>
        </form>
